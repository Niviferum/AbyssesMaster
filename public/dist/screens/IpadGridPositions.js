...
function getGridPosition(period, row, col) {
...
function getGridPositionSafe(period, row, col) {
    try {
        const periodKey = period === 'E1' ? 'paleozoique' :
            period === 'E2' ? 'mesozoique' : 'cenozoique';
        const cellKey = `cell_${row}_${col}`;
...
export { IPAD_GRID_POSITIONS, getGridPosition, getGridPositionSafe, ANIMAL_POSITIONS_IPAD, IPAD_REFERENCE };
//# sourceMappingURL=IpadGridPositions.js.map